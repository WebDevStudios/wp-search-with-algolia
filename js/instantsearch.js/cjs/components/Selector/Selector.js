...
function (_Component) {
  ...
  _createClass(Selector, [{
    ...
    value: function render() {
      ...
      return _preactCompat.default.createElement("select", {
        className: (0, _classnames.default)(this.props.cssClasses.select),
        onChange: this.handleChange,
        value: "".concat(currentValue)
      }, options.map(function (option) {
        return _preactCompat.default.createElement("option", {
          className: (0, _classnames.default)(_this.props.cssClasses.option),
