...
import { createDocumentationMessageGenerator, createDocumentationLink, findIndex, isPlainObject, mergeDeep, noop, warning } from './utils';
...
function (_EventEmitter) {
  ...
  function InstantSearch(options) {
    ...
    warning(!searchParameters, "The `searchParameters` option is deprecated and will not be supported in InstantSearch.js 4.x.\n\nYou can replace it with the `configure` widget:\n\n```\nsearch.addWidgets([\n  configure(".concat(JSON.stringify(searchParameters, null, 2), ")\n]);\n```\n\nSee ").concat(createDocumentationLink({
      name: 'configure'
    })));
