...
namespace WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Insights;

use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\InsightsClient;

final class UserInsightsClient
{
    /**
     * @var \WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\InsightsClient
     */
    private $client;
