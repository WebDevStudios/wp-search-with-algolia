...
namespace WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Http\Psr7;
...
class Uri implements UriInterface
{
     ...
     * `WebDevStudios\WPSWA\Vendor\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `WebDevStudios\WPSWA\Vendor\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
