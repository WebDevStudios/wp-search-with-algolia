...
namespace WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\RetryStrategy;

use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Algolia;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Config\AbstractConfig;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Exceptions\AlgoliaException;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Exceptions\BadRequestException;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Exceptions\NotFoundException;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Exceptions\RetriableException;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Exceptions\UnreachableException;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Http\HttpClientInterface;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Http\Psr7\Request;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\Http\Psr7\Uri;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\RequestOptions\RequestOptions;
use WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\RequestOptions\RequestOptionsFactory;
...
use WebDevStudios\WPSWA\Vendor\Psr\Http\Message\UriInterface;
use WebDevStudios\WPSWA\Vendor\Psr\Log\LoggerInterface;
use WebDevStudios\WPSWA\Vendor\Psr\Log\LogLevel;
...
final class ApiWrapper implements ApiWrapperInterface
{
    ...
    /**
     * @var \WebDevStudios\WPSWA\Vendor\Algolia\AlgoliaSearch\RetryStrategy\ClusterHosts
     */
