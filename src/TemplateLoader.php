...
class TemplateLoader {
	 ...
	 * @since   1.0.0
	 *
	 * @param Plugin $plugin The Algolia Plugin.
	 */
	...
	public function load_instantsearch_template() {
		...
		return TemplateUtils::locate_template( 'instantsearch.php' );
	}
	...
	public function load_autocomplete_template() {
		require TemplateUtils::locate_template( 'autocomplete.php' );
	}
	 ...
	 * @see        TemplateUtils::locate_template()
	 *
	...
	private function locate_template( $file ) {
		...
		return TemplateUtils::locate_template( $file );
	}
}
