<?php
/**
 * AlgoliaApiKey Setting class file.
 *
 ...
 * @since 2.0.0
 */
class AlgoliaApiKey extends Service {
	 ...
	 * @var string
	 */
	protected $option_name = 'algolia_api_key';
	...
	public function sanitize_callback( ?string $value = '' ): ?string {
		...
		if ( $this->algolia_settings->is_api_key_in_config() ) {
			$value = $this->algolia_settings->get_api_key();
		}
	...
	public function render_field(): void {
		include_once WPSWA_PLUGIN_DIR . '/src/Views/Admin/Settings/AlgoliaApiKey.php';
	}
}
