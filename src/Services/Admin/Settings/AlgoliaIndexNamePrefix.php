<?php
/**
 * AlgoliaIndexNamePrefix Setting class file.
 *
 ...
 * @since 2.0.0
 */
class AlgoliaIndexNamePrefix extends Service {
	 ...
	 * @var string
	 */
	protected $option_name = 'algolia_index_name_prefix';
	...
	public function sanitize_callback( ?string $value = '' ): ?string {
		...
		if ( $this->algolia_settings->is_index_prefix_in_config() ) {
	...
	public function render_field(): void {
		include_once WPSWA_PLUGIN_DIR . '/src/Views/Admin/Settings/AlgoliaIndexNamePrefix.php';
	}
}
