<?php
/**
 * AlgoliaSearchApiKey Setting class file.
 *
 ...
 * @since 2.0.0
 */
class AlgoliaSearchApiKey extends Service {
	 ...
	 * @var string
	 */
	protected $option_name = 'algolia_search_api_key';
	...
	public function sanitize_callback( ?string $value = '' ): ?string {
		...
		if ( $this->algolia_settings->is_search_key_in_config() ) {
	...
	public function render_field(): void {
		include_once WPSWA_PLUGIN_DIR . '/src/Views/Admin/Settings/AlgoliaSearchApiKey.php';
	}
}
