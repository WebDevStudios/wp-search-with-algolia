...
class AdminTemplateNotices {
	...
	public function template_version_notices() {
		...
		$core_template_paths = TemplateUtils::get_core_template_paths();

		$custom_template_paths = TemplateUtils::get_custom_template_paths();
		...
		foreach ( $custom_template_paths as $filename => $file_path ) {
			$core_template_versions[ $filename ]   = TemplateUtils::get_template_version(
				$core_template_paths[ $filename ]
			);
			$custom_template_versions[ $filename ] = TemplateUtils::get_template_version(
				$file_path
			);
		}
