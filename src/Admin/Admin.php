...
class Admin {
	...
	public function __construct( Plugin $plugin ) {
		...
		$api = $plugin->get_api();
		if ( $api->is_reachable() ) {
			new AdminAutocomplete( $plugin->get_settings(), $this->plugin->get_autocomplete_config() );
			new AdminNativeSearch( $plugin );
		...
		new AdminTemplateNotices();

		new AdminSettings( $plugin );
