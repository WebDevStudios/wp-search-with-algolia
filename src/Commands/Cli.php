...
namespace WebDevStudios\WPSWA\Commands;
...
class Cli extends WP_CLI_Command {
	...
	public function __construct() {
		$this->plugin = PluginFactory::create();
	}
	 ...
	 * @since  1.0.0
	 *
	 * @param AbstractIndex $index Algolia_Index instance.
	 * @param bool          $clear Clear all existing records prior to pushing the records.
	 *
	 * @return void
	 */
	private function do_reindex( AbstractIndex $index, $clear ) {
