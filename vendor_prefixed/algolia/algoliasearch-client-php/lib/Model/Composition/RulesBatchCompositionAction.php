...
class RulesBatchCompositionAction extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'conditions' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\Condition[]',
        'consequence' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\CompositionRuleConsequence',
        'description' => 'string',
        'enabled' => 'bool',
        'validity' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\TimeRange[]',
        'tags' => 'string[]',
    ];
