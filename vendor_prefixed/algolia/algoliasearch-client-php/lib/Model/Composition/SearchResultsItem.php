...
class SearchResultsItem extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'exhaustive' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\Exhaustive',
        'appliedRules' => 'object[]',
        'exhaustiveFacetsCount' => 'bool',
        'exhaustiveNbHits' => 'bool',
        'exhaustiveTypo' => 'bool',
        'facets' => 'array<string,array<string,int>>',
        'facetsStats' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\FacetStats>',
        'index' => 'string',
        'indexUsed' => 'string',
        'message' => 'string',
        'nbSortedHits' => 'int',
        ...
        'redirect' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\Redirect',
        ...
        'hits' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\Hit[]',
        'hitsPerPage' => 'int',
        'nbHits' => 'int',
        'nbPages' => 'int',
        'page' => 'int',
        ...
        'query' => 'string',
        'feedID' => 'string',
        'compositions' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\ResultsCompositionInfoResponse>',
    ];
