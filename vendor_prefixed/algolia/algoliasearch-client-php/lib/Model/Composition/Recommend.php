...
class Recommend extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'indexName' => 'string',
        'model' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\Model',
        'threshold' => 'int',
        'queryParameters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\BaseInjectionQueryParameters',
        'fallbackParameters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\BaseInjectionQueryParameters',
    ];
