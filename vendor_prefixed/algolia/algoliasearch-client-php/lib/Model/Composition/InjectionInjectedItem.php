...
class InjectionInjectedItem extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'key' => 'string',
        'source' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\InjectedItemSource',
        'position' => 'int',
        'length' => 'int',
        'metadata' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Composition\InjectedItemMetadata',
    ];
