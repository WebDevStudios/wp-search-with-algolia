...
class ABTest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'stoppedAt' => 'string',
        'name' => 'string',
        'status' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Abtesting\Status',
        'variants' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Abtesting\Variant[]',
        'configuration' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Abtesting\ABTestConfiguration',
    ];
