...
class DictionaryEntry extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'language' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\SupportedLanguage',
        'word' => 'string',
        'words' => 'string[]',
        'decomposition' => 'string[]',
        'state' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\DictionaryEntryState',
        'type' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\DictionaryEntryType',
    ];
