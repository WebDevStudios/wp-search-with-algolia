...
class Hit extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'highlightResult' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\HighlightResult>',
        'snippetResult' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\SnippetResult>',
        'rankingInfo' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\RankingInfo',
        'distinctSeqID' => 'int',
    ];
