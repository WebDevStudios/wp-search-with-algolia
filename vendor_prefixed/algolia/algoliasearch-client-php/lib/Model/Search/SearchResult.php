...
class SearchResult extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'exhaustive' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Exhaustive',
        'appliedRules' => 'object[]',
        'exhaustiveFacetsCount' => 'bool',
        'exhaustiveNbHits' => 'bool',
        'exhaustiveTypo' => 'bool',
        'facets' => 'array<string,array<string,int>>',
        'facetsStats' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\FacetStats>',
        'index' => 'string',
        'indexUsed' => 'string',
        'message' => 'string',
        'nbSortedHits' => 'int',
        ...
        'redirect' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Redirect',
        ...
        'nbPages' => 'int',
        'hitsPerPage' => 'int',
        'hits' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Hit[]',
        'query' => 'string',
        'params' => 'string',
        'extensions' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\ResponseExtensions',
        'facetHits' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\FacetHits[]',
    ];
