...
class ConsequenceParams extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'similarQuery' => 'string',
        'filters' => 'string',
        'facetFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\FacetFilters',
        'optionalFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\OptionalFilters',
        'numericFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\NumericFilters',
        'tagFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\TagFilters',
        ...
        'aroundRadius' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AroundRadius',
        'aroundPrecision' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AroundPrecision',
        'minimumAroundRadius' => 'int',
        'insideBoundingBox' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\InsideBoundingBox',
        'insidePolygon' => 'float[][]',
        'naturalLanguages' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\SupportedLanguage[]',
        'ruleContexts' => 'string[]',
        ...
        'typoTolerance' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\TypoTolerance',
        'allowTyposOnNumericTokens' => 'bool',
        'disableTypoToleranceOnAttributes' => 'string[]',
        'ignorePlurals' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\IgnorePlurals',
        'removeStopWords' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\RemoveStopWords',
        'queryLanguages' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\SupportedLanguage[]',
        'decompoundQuery' => 'bool',
        'enableRules' => 'bool',
        'enablePersonalization' => 'bool',
        'queryType' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\QueryType',
        'removeWordsIfNoResults' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\RemoveWordsIfNoResults',
        'mode' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Mode',
        'semanticSearch' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\SemanticSearch',
        'advancedSyntax' => 'bool',
        'optionalWords' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\OptionalWords',
        'disableExactOnAttributes' => 'string[]',
        'exactOnSingleWordQuery' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\ExactOnSingleWordQuery',
        'alternativesAsExact' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AlternativesAsExact[]',
        'advancedSyntaxFeatures' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AdvancedSyntaxFeatures[]',
        'distinct' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Distinct',
        ...
        'renderingContent' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\RenderingContent',
        'enableReRanking' => 'bool',
        'reRankingApplyFilter' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\ReRankingApplyFilter',
        'query' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\ConsequenceQuery',
        'automaticFacetFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AutomaticFacetFilters',
        'automaticOptionalFacetFilters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\AutomaticFacetFilters',
    ];
