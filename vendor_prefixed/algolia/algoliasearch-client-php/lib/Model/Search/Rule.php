...
class Rule extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'conditions' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Condition[]',
        'consequence' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Consequence',
        'description' => 'string',
        'enabled' => 'bool',
        'validity' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\TimeRange[]',
        'tags' => 'string[]',
        'scope' => 'string',
        'condition' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Search\Condition',
    ];
