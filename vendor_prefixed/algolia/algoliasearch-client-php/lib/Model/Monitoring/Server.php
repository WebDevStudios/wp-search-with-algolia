...
class Server extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'name' => 'string',
        'region' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Monitoring\Region',
        'isSlave' => 'bool',
        'isReplica' => 'bool',
        'cluster' => 'string',
        'status' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Monitoring\ServerStatus',
        'type' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Monitoring\Type',
    ];
