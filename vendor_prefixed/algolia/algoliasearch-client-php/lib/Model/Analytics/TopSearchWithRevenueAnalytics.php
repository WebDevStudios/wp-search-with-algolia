...
namespace WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Analytics;
...
class TopSearchWithRevenueAnalytics extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'clickPositions' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Analytics\ClickPosition[]',
        'conversionRate' => 'float',
        'trackedSearchCount' => 'int',
        'clickCount' => 'int',
        'conversionCount' => 'int',
        'nbHits' => 'int',
        'currencies' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Analytics\CurrencyCode>',
        'addToCartRate' => 'float',
        'addToCartCount' => 'int',
        'purchaseRate' => 'float',
        'purchaseCount' => 'int',
