...
class MappingInput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'format' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\MappingFormatSchema',
        'actions' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\MappingKitAction[]',
    ];
