...
class Authentication extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'type' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\AuthenticationType',
        'name' => 'string',
        'platform' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\Platform',
        'owner' => 'string',
        'input' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\AuthInputPartial',
        'createdAt' => 'string',
        'updatedAt' => 'string',
    ];
