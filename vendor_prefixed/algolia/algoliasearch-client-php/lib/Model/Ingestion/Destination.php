...
class Destination extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'type' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\DestinationType',
        'name' => 'string',
        'owner' => 'string',
        'input' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\DestinationInput',
        'createdAt' => 'string',
        'updatedAt' => 'string',
