...
class TransformationTry extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'code' => 'string',
        'type' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\TransformationType',
        'input' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\TransformationInput',
        'sampleRecord' => 'object',
        'authentications' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\AuthenticationCreate[]',
    ];
