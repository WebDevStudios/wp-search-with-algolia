...
class SourceInput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'customFields' => 'string[]',
        'storeHash' => 'string',
        'channel' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\BigCommerceChannel',
        'productMetafields' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\BigCommerceMetafield[]',
        'variantMetafields' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\BigCommerceMetafield[]',
        'uniqueIDColumn' => 'string',
        'method' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\MethodType',
        'mapping' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\MappingTypeCSV>',
        'delimiter' => 'string',
        'projectID' => 'string',
        'datasetID' => 'string',
        'dataType' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Ingestion\BigQueryDataType',
        'table' => 'string',
        'tablePrefix' => 'string',
