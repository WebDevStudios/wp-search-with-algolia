...
class AddABTestsRequest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'name' => 'string',
        'variants' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\AbtestingV3\AddABTestsVariant[]',
        'metrics' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\AbtestingV3\CreateMetric[]',
        'configuration' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\AbtestingV3\ABTestConfiguration',
        'endAt' => 'string',
    ];
