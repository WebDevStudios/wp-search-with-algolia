...
class AddedToCartObjectIDsAfterSearch extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'eventName' => 'string',
        'eventType' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Insights\ConversionEvent',
        'eventSubtype' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Insights\AddToCartEvent',
        'index' => 'string',
        'queryID' => 'string',
        'objectIDs' => 'string[]',
        'userToken' => 'string',
        ...
        'currency' => 'string',
        'objectData' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Insights\ObjectDataAfterSearch[]',
        'timestamp' => 'int',
        'value' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Insights\Value',
    ];
