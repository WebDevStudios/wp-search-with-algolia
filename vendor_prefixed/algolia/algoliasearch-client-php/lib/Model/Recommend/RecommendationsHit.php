...
class RecommendationsHit extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'highlightResult' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\HighlightResult>',
        'snippetResult' => 'array<string,\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\SnippetResult>',
        'rankingInfo' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\RankingInfo',
        'distinctSeqID' => 'int',
        'score' => 'float',
        'facetName' => 'string',
        'facetValue' => 'string',
