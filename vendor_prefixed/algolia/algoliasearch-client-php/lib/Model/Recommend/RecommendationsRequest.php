...
class RecommendationsRequest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'queryParameters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\RecommendSearchParams',
        'model' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\LookingSimilarModel',
        'objectID' => 'string',
        'fallbackParameters' => '\WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Model\Recommend\FallbackParams',
        'facetName' => 'string',
        'facetValue' => 'string',
    ];
