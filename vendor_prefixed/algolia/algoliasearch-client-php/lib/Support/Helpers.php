...
use WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Exceptions\ExceededRetriesException;
...
final class Helpers
{
    ...
    public static function retryUntil(
        ...
        $maxRetries,
        $timeout,
        $timeoutCalculation = 'WebDevStudios\WPSWA\Algolia\AlgoliaSearch\Support\Helpers::linearTimeout'
    ) {
        $retry = 0;
